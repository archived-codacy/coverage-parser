...
import com.codacy.parsers.implementation.{CoberturaParser, JacocoParser, LCOVParser}
...
object CoverageParser {
  ...
  val parsers: List[CoverageParser] = List(CoberturaParser, JacocoParser, LCOVParser)
